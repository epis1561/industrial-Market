<template>
    ...
    <div id="wrap">
        ...
        <infinite-scroll v-if="events.meta" :loading="loading" :form="form" :meta="events.meta" :target-class="'.event-list'" :target-scroll="'.subpage'" @scroll="(page) => {form.page = page; getEvents(true)}" />
    </div>
    </body>
</template>
