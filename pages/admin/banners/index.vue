    ...
    <div class="admin-wrap table-wrap">
        ...
        <div class="title-wrap col-group">
            ...
            <div class="top-btn-wrap col-group">
                <a :href="`/admin/banners/create`" class="btn">
                    등록
                </a>
            </div>
        </div>
            ...
            <tr class="admin-tr" v-for="item in items.data" :key="item.id">
                ...
                <td class="admin-td">
                    <div class="btn-wrap col-group">
                        <nuxt-link :to="`/admin/banners/create?id=${item.id}`" class="btn">
                            상세
                        </nuxt-link>
...
export default {
    ...
    methods: {
        filter(){
            this.$axios.get("/api/admin/banners", {
        ...
        remove(item){
            ...
            if(confirmed)
                this.form.delete("/api/admin/banners/" + item.id)
                    .then(response => {
        ...
        up(item){
            ...
            if (index > 0) {
                ...
                this.form.patch("/api/admin/banners/" + item.id + "/up");
            }
        },
        ...
        down(item){
            ...
            if (index < this.items.data.length - 1) {
                ...
                this.form.patch("/api/admin/banners/" + item.id + "/down");
