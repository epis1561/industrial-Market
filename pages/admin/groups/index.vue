    ...
    <div class="admin-wrap table-wrap">
        ...
        <div class="title-wrap col-group">
            <div class="main-title-wrap col-group">
                ...
                <div class="top-btn-wrap">
                    <nuxt-link :to="`/admin/groups/create`" class="btn">
                        등록
                    </nuxt-link>
                </div>
            </div>
        ...
        <table class="admin-table">
            ...
            <tr class="admin-tr" v-for="item in items.data" :key="item.id">
                ...
                <td class="admin-td">{{item.format_tags}}</td>
                <td class="admin-td">{{item.created_at}}</td>

                <td class="admin-td">
                    <div class="btn-wrap col-group">
                        <nuxt-link :to="`/admin/groups/create?id=${item.id}`" class="btn">
                            상세
                        </nuxt-link>
...
export default {
    ...
    methods: {
        ...
        remove(item){
            ...
            if(confirmed)
                this.form.delete("/api/admin/groups/" + item.id)
                    .then(response => {
        ...
        up(item){
            ...
            this.form.patch("/api/admin/groups/" + item.id + "/up");
        },
        ...
        down(item){
            ...
            this.form.patch("/api/admin/groups/" + item.id + "/down");
        }
    },
