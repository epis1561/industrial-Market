        ...
        <div class="title-wrap col-group">
            <div class="main-title-wrap col-group">
                ...
                <div class="top-btn-wrap">
                    <nuxt-link :to="`/admin/communities/create`" class="btn">
                        등록
                    </nuxt-link>
                </div>
            </div>
            ...
            <tr class="admin-tr" v-for="item in items.data" :key="item.id">
                ...
                <td class="admin-td">
                    <div class="btn-wrap col-group">
                        <nuxt-link :to="`/admin/communities/create?id=${item.id}`" class="btn">
                            상세
                        </nuxt-link>
...
export default {
    ...
    methods: {
        filter(){
            this.$axios.get("/api/admin/communities", {
        ...
        remove(item){
            ...
            if(confirmed)
                this.form.delete("/api/admin/communities/" + item.id)
                    .then(response => {
        ...
        up(item){
            ...
            if (index > 0) {
                ...
                this.form.patch("/api/admin/communities/" + item.id + "/up");
            }
        },
        ...
        down(item){
            ...
            if (index < this.items.data.length - 1) {
                ...
                this.form.patch("/api/admin/communities/" + item.id + "/down");
